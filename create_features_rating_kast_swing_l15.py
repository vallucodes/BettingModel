...
def weighted_rolling_mean(group, stat_col, weight_col, window=15):
    results = []
...
for team_name, group in team_match_stats.groupby('team_name'):
    ...
    group['rolling_rating_l15'] = weighted_rolling_mean(group, 'rating', 'total_rounds')
    group['rolling_kast_l15'] = weighted_rolling_mean(group, 'kast_pct', 'total_rounds')
    group['rolling_swing_l15'] = weighted_rolling_mean(group, 'swing_pct', 'total_rounds')
    group['rolling_win_rate_l15'] = weighted_rolling_mean(group, 'won', 'total_rounds')
...
team1_stats = rolling_df[rolling_df['side'] == 'team1'][[
    'hltv_match_id', 'rolling_rating_l15', 'rolling_kast_l15',
    'rolling_swing_l15', 'rolling_win_rate_l15'
]].rename(columns={
    'rolling_rating_l15': 'team1_rolling_rating_l15',
    'rolling_kast_l15': 'team1_rolling_kast_l15',
    'rolling_swing_l15': 'team1_rolling_swing_l15',
    'rolling_win_rate_l15': 'team1_rolling_win_rate_l15'
})
...
team2_stats = rolling_df[rolling_df['side'] == 'team2'][[
    ...
    'rolling_rating_l15': 'team2_rolling_rating_l15',
    'rolling_kast_l15': 'team2_rolling_kast_l15',
    'rolling_swing_l15': 'team2_rolling_swing_l15',
    'rolling_win_rate_l15': 'team2_rolling_win_rate_l15'
})

features_df = matches_df.merge(team1_stats, on='hltv_match_id', how='left') \
                        .merge(team2_stats, on='hltv_match_id', how='left')

output_path = os.path.join(FEATURES_DIR, "features_rolling_l15.parquet")
...
print(features_df[['hltv_match_id', 'team1_name', 'team2_name',
                   ...
                   'team1_rolling_win_rate_l15', 'team2_rolling_win_rate_l15']].head(10).to_string())
