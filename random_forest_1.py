...
RUN_NOTE = "rf_l15_map_190_90_17_team_130_50_25"
...
# Trees don't require scaling, but keeping it for consistency is fine
...
# Random Forest with conservative settings to reduce overfitting
...
def evaluate_split(model, inputs, targets, name: str = ""):
    ...
    return {"log_loss": ll, "roc_auc": roc, "brier": brier, "probs": probs}


train_metrics = evaluate_split(rf, train_inputs, train_targets, "Train")
test_metrics = evaluate_split(rf, test_inputs, test_targets, "Test")
